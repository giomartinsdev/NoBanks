        ...
        try:
            ...
            match menu_input:
                ...
                case 1:
                    ...
                    deposito_saldo_usu = float(input('Entre com o saldo para ser adicionado: '))
                    depositar_saldo(id_usu, deposito_saldo_usu)
                    break
                case 2:
                ...
                case 4:
                    if(has_admin_permission):
                        ...
                        criar_usuario(name_usu, email_usu, cpf_usu, senha_usu)
                        break
                    else:
